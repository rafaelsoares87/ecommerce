                                    ...
                                    <div class="">
                                        ...
                                        <div class="mb-3">
                                            <input type="text" class="form-control"
                                                placeholder="adicionar nome do produto" name="title_product">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="">
                                        ...
                                        <div class="mb-3">
                                            <input type="file" class="form-control" placeholder="adicionar categoria"
                                                name="image">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="adicionar categoria do produto" name="price_production">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    ...
                                    <div class="">
                                        <div class="mb-3">
                                            <label for="exampleFormControlTextarea1" class="form-label">Adicionar
                                                descrição</label>
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description_product"></textarea>
                                        </div>
                                    </div>
                                </div>
