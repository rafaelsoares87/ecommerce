    ...
    <header>
        <nav class="navbar navbar-expand-xl bg-light">
            <div class="container">
                ...
                <form action="{{route('search-product')}}" class="input-group" method="POST">
                    @csrf
                    
                    <span class="input-group-text" id="basic-addon1"> <i
                            class="fa-solid fa-magnifying-glass"></i></span>
                    <input type="search" class="form-control" name="search" placeholder="Buscar games" aria-label=""
    ...
    <main class="pt-5">
        <div class="container card border-white ">
            <div class="card-header bg-success text-white mb-3">
                OS MELHOERES JOGOS PARA CONSOLES E PC
            </div>
            <!-- Products/Categories -->
            <div class="row">
                        ...
                        @foreach ($categories as $category)
                            <li class="list-group-item">
                                <div class="d-grid gap-2 ">
                                    <a href="{{route('dashboard-show', ['id' => $category->id])}}" class="nav-link nav-item" > 
                            ...
                            <div class="col-lg-3">
                                <div class="card border-success">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="text-success">R${{$product->price_production}}</h5>
                                        <p class="card-text"><small class="text-muted">A vista</small></p>

                                    </div>
                                    <div class="card-footer bg-white text-white">
                                        <div class="d-grid gap-2 ">
                                            <a href="{{route('product_show', ['id' => $product->id])}}" class="btn btn-lg btn-success" type="button"> <i
